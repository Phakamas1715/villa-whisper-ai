...
const translations: Translations = {
  ...
  // Finance Module
  'finance.title': { th: 'บัญชีและการเงิน', en: 'Accounting & Finance' },
  'finance.subtitle': { th: 'รายรับ · รายจ่าย · มัดจำ · กำไรขั้นต้นรายยูนิต', en: 'Income · Expenses · Deposits · Per-Unit Gross Profit' },
  'finance.export': { th: 'ส่งออก', en: 'Export' },
  'finance.total_income': { th: 'รายรับรวม', en: 'Total Income' },
  'finance.total_expense': { th: 'รายจ่ายรวม', en: 'Total Expense' },
  'finance.gross_profit': { th: 'กำไรขั้นต้น', en: 'Gross Profit' },
  'finance.deposits_held': { th: 'มัดจำค้าง', en: 'Deposits Held' },
  'finance.two_guests': { th: '2 แขก', en: '2 guests' },
  'finance.income_vs_expense': { th: 'รายรับ vs รายจ่าย', en: 'Income vs Expense' },
  'finance.six_months': { th: 'ย้อนหลัง 6 เดือน', en: 'Last 6 Months' },
  'finance.income': { th: 'รายรับ', en: 'Income' },
  'finance.expense': { th: 'รายจ่าย', en: 'Expense' },
  'finance.expense_breakdown': { th: 'สัดส่วนรายจ่าย', en: 'Expense Breakdown' },
  'finance.unit_profit': { th: 'กำไรรายยูนิต', en: 'Per-Unit Profit' },
  'finance.deposit_tracking': { th: 'ติดตามเงินมัดจำ', en: 'Deposit Tracking' },
  'finance.held': { th: 'ค้างไว้', en: 'Held' },
  'finance.refunded': { th: 'คืนแล้ว', en: 'Refunded' },
  'finance.pending': { th: 'รอดำเนินการ', en: 'Pending' },
  'finance.recent_transactions': { th: 'รายการล่าสุด', en: 'Recent Transactions' },
  'finance.view_all': { th: 'ดูทั้งหมด', en: 'View All' },

  // Pricing Page (5 tiers)
  'pricing.title': { th: 'แพ็กเกจราคาที่ออกแบบมาเพื่อเจ้าของไทย', en: 'Plans Built for Thai Property Owners' },
  'pricing.subtitle': { th: 'เริ่มฟรี 1 ยูนิต — ขยายได้ตามธุรกิจโต ไม่ผูกสัญญา', en: 'Start free with 1 unit — scale as you grow, no contracts' },
  'pricing.period': { th: '/เดือน', en: '/month' },
  'pricing.popular': { th: 'แนะนำ', en: 'Recommended' },
  'pricing.cta_free': { th: 'เริ่มใช้ฟรี', en: 'Start Free' },
  'pricing.cta_trial': { th: 'ทดลอง 30 วัน ฟรี', en: '30-Day Free Trial' },
  'pricing.guarantee': { th: '✅ ทดลองฟรี 30 วัน · คืนเงิน 100% · ไม่ผูกสัญญา · ยกเลิกได้ทุกเมื่อ', en: '✅ 30-day free trial · 100% refund · No contract · Cancel anytime' },

  'pricing.free.name': { th: 'Free', en: 'Free' },
  'pricing.free.desc': { th: '1 ยูนิต · เริ่มต้นใช้ทันที', en: '1 unit · Get started instantly' },
  'pricing.free.f1': { th: 'AI Chat ตอบแขกอัตโนมัติ', en: 'AI Auto-reply for guests' },
  'pricing.free.f2': { th: 'ปฏิทินจอง + ภาพรวม', en: 'Booking calendar + overview' },
  'pricing.free.f3': { th: 'Overbooking Shield', en: 'Overbooking Shield' },
  'pricing.free.f4': { th: 'TM30 แจ้งเตือน', en: 'TM30 alerts' },
  'pricing.free.f5': { th: 'Dashboard พื้นฐาน', en: 'Basic Dashboard' },

  'pricing.starter.name': { th: 'Starter', en: 'Starter' },
  'pricing.starter.desc': { th: '1–3 ยูนิต · ทุกฟีเจอร์หลัก', en: '1–3 units · All core features' },
  'pricing.starter.f1': { th: 'ทุกอย่างใน Free +', en: 'Everything in Free +' },
  'pricing.starter.f2': { th: 'Zero-Phone Guest Journey', en: 'Zero-Phone Guest Journey' },
  'pricing.starter.f3': { th: 'TM30/TDAC อัตโนมัติ', en: 'Auto TM30/TDAC' },
  'pricing.starter.f4': { th: 'บันทึกรายรับ-จ่าย', en: 'Income/Expense tracking' },
  'pricing.starter.f5': { th: 'รองรับ 10+ ภาษา', en: '10+ Languages' },

  'pricing.pro.name': { th: 'Pro', en: 'Pro' },
  'pricing.pro.desc': { th: '4–10 ยูนิต · AI + Operations ครบ', en: '4–10 units · Full AI + Operations' },
  'pricing.pro.f1': { th: 'ทุกอย่างใน Starter +', en: 'Everything in Starter +' },
  'pricing.pro.f2': { th: 'Thai Ops Hub แม่บ้าน/ช่าง', en: 'Thai Ops Hub for staff' },
  'pricing.pro.f3': { th: 'AI Dynamic Pricing', en: 'AI Dynamic Pricing' },
  'pricing.pro.f4': { th: 'กำไรขั้นต้นรายยูนิต', en: 'Per-unit gross profit' },
  'pricing.pro.f5': { th: 'Export ภาษี ภ.ง.ด.', en: 'Tax Export (PND)' },
  'pricing.pro.f6': { th: 'มัดจำ + Auto Charge', en: 'Deposits + Auto Charge' },

  'pricing.business.name': { th: 'Business', en: 'Business' },
  'pricing.business.desc': { th: '11–30 ยูนิต · Community + AI Damage', en: '11–30 units · Community + AI Damage' },
  'pricing.business.f1': { th: 'ทุกอย่างใน Pro +', en: 'Everything in Pro +' },
  'pricing.business.f2': { th: 'Community Network', en: 'Community Network' },
  'pricing.business.f3': { th: 'AI Damage Detection', en: 'AI Damage Detection' },
  'pricing.business.f4': { th: 'รายงานการเงินขั้นสูง', en: 'Advanced financial reports' },
  'pricing.business.f5': { th: 'Auto Charge PromptPay/Stripe', en: 'Auto Charge PromptPay/Stripe' },
  'pricing.business.f6': { th: 'Priority Support LINE', en: 'Priority LINE Support' },

  'pricing.enterprise.name': { th: 'Enterprise', en: 'Enterprise' },
  'pricing.enterprise.desc': { th: '30+ ยูนิต — ปรับแต่งตามธุรกิจ + Dedicated Support + API เชื่อมต่อระบบเดิม', en: '30+ units — Custom setup + Dedicated Support + API integrations' },
  'pricing.enterprise.f1': { th: 'ทุกอย่างใน Business', en: 'Everything in Business' },
  'pricing.enterprise.f2': { th: 'API เชื่อมต่อระบบเดิม', en: 'Custom API integrations' },
  'pricing.enterprise.f3': { th: 'Dedicated Account Manager', en: 'Dedicated Account Manager' },
  'pricing.enterprise.f4': { th: 'SLA 99.9%', en: '99.9% SLA' },
  'pricing.enterprise.cta': { th: 'ติดต่อฝ่ายขาย', en: 'Contact Sales' },
};
